...
dados2 <- dados[dados$x2 == 1,] # somente observacoes com x2 = 1
sum(dados$x2 == 1) # numero de observacoes em que x2 = 1 (fez curso aprendizagem)
...
# filtrar para considerar apenas imoveis disponiveis para aluguel
